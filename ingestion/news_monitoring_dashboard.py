...
from news_daily_scheduler import NewsDailyScheduler
...
class NewsMonitoringDashboard:
    ...
    def __init__(self, database_url: str):
        ...
        # File paths
        self.ingestion_dir = Path(__file__).parent
        self.stats_file = self.ingestion_dir / 'daily_sync_stats.json'
        self.progress_file = self.ingestion_dir / 'daily_sync_progress.json'
